...
namespace XmobiTea.ProtonNet.Server.WebApi.Helper
{
    ...
    static class DetectUrlUtils
    {
        ...
        public static string GetFullPrefix(HttpMethodAttribute httpMethodAttribute, RouteAttribute routeAttribute)
        {
            ...
            if (!string.IsNullOrEmpty(httpMethodAttribute.Prefix))
            {
                if (!string.IsNullOrEmpty(httpMethodAttribute.Name))
                    ...
                    answer = httpMethodAttribute.Prefix;
            }
            else
            {
        ...
        public static List<string> GetSinglePrefixLst(HttpMethodAttribute httpMethodAttribute, RouteAttribute routeAttribute)
        {
            ...
            return GetSinglePrefixLst(fullPrefix);
        }

        /// <summary>
        /// Retrieves a list of single prefixes from the given full prefix string.
        /// </summary>
        /// <param name="fullPrefix">The full prefix string to be split into single prefixes.</param>
        /// <returns>A list of single prefixes parsed from the full prefix.</returns>
        public static List<string> GetSinglePrefixLst(string fullPrefix)
        {
