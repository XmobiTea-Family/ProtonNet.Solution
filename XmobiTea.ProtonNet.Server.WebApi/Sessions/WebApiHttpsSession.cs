...
{
    /// <summary>
    /// Represents an HTTPS session in the Web API server.
    /// </summary>
    class WebApiHttpsSession : HttpsSession, IWebApiSession
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebApiHttpsSession"/> class.
        /// </summary>
        ...
        public WebApiHttpsSession(WebApiHttpsServer server, IWebApiServerContext context) : base(server)
        {
        ...
        public HypertextTransferProtocol GetHypertextTransferProtocol() => HypertextTransferProtocol.Https;
