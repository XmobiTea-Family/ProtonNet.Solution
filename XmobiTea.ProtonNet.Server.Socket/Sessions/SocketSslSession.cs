...
namespace XmobiTea.ProtonNet.Server.Socket.Sessions
{
    ...
    /// </summary>
    class SocketSslSession : SslSession, ISocketSession
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketSslSession"/> class using the specified server and context.
        /// </summary>
        ...
        public SocketSslSession(SocketSslServer server, ISocketServerContext context) : base(server)
        {
        ...
        public TransportProtocol GetTransportProtocol() => TransportProtocol.Ssl;
