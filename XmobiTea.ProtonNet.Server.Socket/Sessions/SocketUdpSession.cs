...
namespace XmobiTea.ProtonNet.Server.Socket.Sessions
{
    ...
    /// </summary>
    class SocketUdpSession : UdpSession, ISocketSession
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketUdpSession"/> class using the specified server and context.
        /// </summary>
        ...
        public SocketUdpSession(SocketUdpServer server, ISocketServerContext context) : base(server)
        {
        ...
        public TransportProtocol GetTransportProtocol() => TransportProtocol.Udp;
        ...
        public string GetRemoteIP() => this.RemoteEndPoint == null ? string.Empty : (this.RemoteEndPoint as System.Net.IPEndPoint).Address.ToString();

        /// <summary>
        /// Gets the remote port number of the connected client.
        /// </summary>
        /// <returns>The remote port number.</returns>
        public int GetRemotePort() => this.RemoteEndPoint == null ? -1 : (this.RemoteEndPoint as System.Net.IPEndPoint).Port;
