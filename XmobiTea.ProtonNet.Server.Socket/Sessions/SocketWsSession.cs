...
namespace XmobiTea.ProtonNet.Server.Socket.Sessions
{
    ...
    /// </summary>
    class SocketWsSession : WsSession, ISocketSession
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketWsSession"/> class using the specified server and context.
        /// </summary>
        ...
        public SocketWsSession(SocketWsServer server, ISocketServerContext context) : base(server)
        {
        ...
        public TransportProtocol GetTransportProtocol() => TransportProtocol.Ws;
