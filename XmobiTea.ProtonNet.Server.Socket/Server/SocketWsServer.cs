...
namespace XmobiTea.ProtonNet.Server.Socket.Server
{
    ...
    /// </summary>
    class SocketWsServer : WsServer, IServer
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketWsServer"/> class with the specified address, port, and options.
        /// </summary>
        ...
        public SocketWsServer(string address, int port, TcpServerOptions options, ISocketServerContext context) : base(address, port, options) => this.context = context;
        ...
        /// <summary>
        /// Creates a new instance of the <see cref="SocketWsSession"/> to handle a WebSocket session.
        /// </summary>
        /// <returns>A new <see cref="SocketWsSession"/> instance.</returns>
        protected override TcpSession CreateSession() => new SocketWsSession(this, this.context);
