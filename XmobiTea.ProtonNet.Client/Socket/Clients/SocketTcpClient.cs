...
{
    /// <summary>
    /// Represents a TCP socket client, implementing the <see cref="ISocketClient"/> and <see cref="ISetEncryptKey"/> interfaces.
    /// </summary>
    class SocketTcpClient : ProtonNetClient.TcpClient, ISocketClient, ISetEncryptKey
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketTcpClient"/> class with the specified server address, port, and client options.
        /// </summary>
        /// <param name="address">The server address.</param>
        /// <param name="port">The server port.</param>
        /// <param name="options">The TCP client options.</param>
        public SocketTcpClient(string address, int port, TcpClientOptions options)
