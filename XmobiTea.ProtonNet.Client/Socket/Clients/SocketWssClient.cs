...
namespace XmobiTea.ProtonNet.Client.Socket.Clients
{
    ...
    /// </summary>
    class SocketWssClient : ProtonNetClient.WssClient, ISocketClient, ISetEncryptKey
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketWssClient"/> class with the specified server address, port, client options, and Ssl options.
        /// </summary>
        ...
        public SocketWssClient(string address, int port, TcpClientOptions options, ProtonNetCommon.SslOptions sslOptions)
