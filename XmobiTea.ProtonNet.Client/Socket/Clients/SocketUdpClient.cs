...
{
    /// <summary>
    /// Represents a UDP socket client, implementing the <see cref="ISocketClient"/> and <see cref="ISetEncryptKey"/> interfaces.
    /// </summary>
    class SocketUdpClient : ProtonNetClient.UdpClient, ISocketClient, ISetEncryptKey
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SocketUdpClient"/> class with the specified server address, port, and client options.
        /// </summary>
        /// <param name="address">The server address.</param>
        /// <param name="port">The server port.</param>
        /// <param name="options">The UDP client options.</param>
        public SocketUdpClient(string address, int port, UdpClientOptions options)
        ...
        protected override void OnReceived(EndPoint endpoint, byte[] buffer, int position, int length)
        {
            base.OnReceived(endpoint, buffer, position, length);
